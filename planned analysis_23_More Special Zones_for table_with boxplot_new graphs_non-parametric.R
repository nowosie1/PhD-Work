...
leveneTest(ms)
test_sphericity(ms)
shapiro.test(Mspeed2$gentlecurves)
...
p <- ggplot(Mspeed2, aes(x=group, y=gentlecurves, fill=Age),colour="black") + 
  facet_wrap(~Age)+
  geom_violin(outlier.alpha = 0)+
  geom_jitter(color="black", size=1, alpha=0.95)+
  theme(legend.position = "none")+
...
sdlp <- aov(gentlecurves ~ Age*group, data = SDLP1,anova_table = list(es = "pes"))
summary(sdlp)
eta_squared(sdlp)
emmeans(sdlp,pairwise ~ group )
emmeans(sdlp,pairwise ~ Age|group)
...
p <- ggplot(SDLP1, aes(x=group, y=gentlecurves, fill=Age),colour="black") + 
  facet_wrap(~Age)+
  geom_violin(outlier.alpha = 0)+
  geom_jitter(color="black", size=1, alpha=0.95)+
  theme(legend.position = "none")+
...
ss1 <- oneway.test(gentlecurves~ group,data=SDLP1, var.equal = FALSE)
ss1
...
oneway.test(sharpcurves ~ Age,data=SDLP1, var.equal = FALSE)
...
p <- ggplot(SR1, aes(x=group, y=winding, fill=Age),colour="black") + 
  facet_wrap(~Age)+
  geom_violin()+
  geom_jitter(color="black", size=1, alpha=0.95)+
  theme(legend.position = "none")+
...
p <- ggplot(SLO1, aes(x=group, y=turn1, fill=Age),colour="black") + 
  ...
  geom_jitter(color="black", size=1, alpha=0.95)+
  theme(legend.position = "none")+
  xlab("Motion Group") + ylab(("Longitudinal Acceleration"~Km/h^2))+
  theme(text=element_text(family="Arial", face="bold", size=10))+
  scale_fill_grey(start = 0.50, end = 0.90)+
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
...
boxplot(peaks~group*Age,data=Mspeed)
outliers <- boxplot(peaks~group*Age,data=Mspeed,plot=FALSE)$out
Mspeed1 <- Mspeed
Mspeed1 <- Mspeed1[-which(Mspeed1$peaks %in% outliers),]
boxplot(peaks~group*Age,data=Mspeed1)
...
boxplot(peaks~group*Age,data=SDspeed)
outliers <- boxplot(peaks~group*Age,data=SDspeed,plot=FALSE)$out
SDspeed1 <- SDspeed
SDspeed1 <- SDspeed1[-which(SDspeed1$peaks %in% outliers),]
boxplot(peaks~group*Age,data=SDspeed1)

boxplot(peaks~group*Age,data=SDspeed1)
outliers <- boxplot(peaks~group*Age,data=SDspeed1,plot=FALSE)$out
SDspeed2 <- SDspeed1
SDspeed2 <- SDspeed2[-which(SDspeed2$peaks %in% outliers),]
boxplot(peaks~group*Age,data=SDspeed2)
...
SDLP <- total %>%
  filter(Variable == "SDLP")
sdlp <- aov(peaks ~ Age*group, data = SDLP,anova_table = list(es = "pes"))
summary(sdlp)
eta_squared(sdlp)
emmeans(sdlp,pairwise ~ group )
emmeans(sdlp,pairwise ~ Age|group)
...
boxplot(peaks~group*Age,data=SDLP)
outliers <- boxplot(peaks~group*Age,data=SDLP,plot=FALSE)$out
SDLP1 <- SDLP
SDLP1 <- SDLP1[-which(SDLP1$peaks %in% outliers),]
boxplot(peaks~group*Age,data=SDLP1)

boxplot(peaks~group*Age,data=SDLP1)
outliers <- boxplot(peaks~group*Age,data=SDLP1,plot=FALSE)$out
SDLP2 <- SDLP1
SDLP2 <- SDLP2[-which(SDLP2$peaks %in% outliers),]
boxplot(peaks~group*Age,data=SDLP2)

sdlp <- aov(peaks ~ Age*group, data = SDLP1,anova_table = list(es = "pes"))
summary(sdlp)
eta_squared(sdlp)
emmeans(sdlp,pairwise ~ group )
emmeans(sdlp,pairwise ~ Age|group)
...
SR <- total %>%
  filter(Variable == "Steer Rev")
sr <- aov(peaks ~ Age*group, data = SR,anova_table = list(es = "pes"))
summary(sr)
eta_squared(sr)
emmeans(sr,pairwise ~ Age|group)
emmeans(sr,pairwise ~ group|Age)
...
boxplot(peaks~group*Age,data=SR)
outliers <- boxplot(peaks~group*Age,data=SR,plot=FALSE)$out
SR1 <- SR
SR1 <- SR1[-which(SR1$peaks %in% outliers),]
boxplot(peaks~group*Age,data=SR1)



sr <- aov(peaks ~ Age*group, data = SR2,anova_table = list(es = "pes"))
summary(sr)
eta_squared(sr)
emmeans(sr,pairwise ~ Age|group)
emmeans(sr,pairwise ~ group|Age)
...
LD <- total %>%
  filter(Variable == "Lane departures")
ld <- aov(peaks ~ Age*group, data = LD)
summary(ld)
eta_squared(ld)
emmeans(ld,pairwise ~ group|Age)
emmeans(ld,pairwise ~ group)
...
boxplot(peaks~group*Age,data=LD)
outliers <- boxplot(peaks~group*Age,data=LD,plot=FALSE)$out
LD1 <- LD
LD1 <- LD1[-which(LD1$peaks %in% outliers),]
boxplot(peaks~group*Age,data=LD1)

LD <- total %>%
  filter(Variable == "Lane departures")
ld <- aov(peaks ~ Age*group, data = LD1,anova_table = list(es = "pes"))
summary(ld)
eta_squared(ld)
emmeans(ld,pairwise ~ group|Age)
emmeans(ld,pairwise ~ scenario)
...
MLO <- total %>%
  filter(Variable == "Mean Long acc")
mlo <- aov(peaks ~ Age*group, data = MLO,anova_table = list(es = "pes"))
summary(mlo)
eta_squared(mlo)
emmeans(mlo,pairwise ~ Age)
emmeans(mlo,pairwise ~ scenario)
...
boxplot(peaks~group*Age,data=MLO)
outliers <- boxplot(peaks~group*Age,data=MLO,plot=FALSE)$out
MLO1 <- MLO
MLO1 <- MLO1[-which(MLO1$peaks %in% outliers),]
boxplot(peaks~group*Age,data=MLO1)

MLO <- total %>%
  filter(Variable == "Mean Long acc")
mlo <- aov(peaks ~ Age*group, data = MLO1,anova_table = list(es = "pes"))
summary(mlo)
eta_squared(mlo)
emmeans(mlo,pairwise ~ Age)
emmeans(mlo,pairwise ~ Age|group)
...
SLO <- total %>%
  filter(Variable == "SD Long acc")
slo <- aov(peaks ~ Age*group, data = SLO1,anova_table = list(es = "pes"))
summary(slo)
eta_squared(slo)
emmeans(slo,pairwise ~ group)
emmeans(slo,pairwise ~ Age|group)
...
boxplot(peaks~group*Age,data=SLO)
outliers <- boxplot(peaks~group*Age,data=SLO,plot=FALSE)$out
SLO1 <- SLO
SLO1 <- SLO1[-which(SLO1$peaks %in% outliers),]
boxplot(peaks~group*Age,data=SLO1)
...
boxplot(h1~group*Age,data=Mspeed)
outliers <- boxplot(h1~group*Age,data=Mspeed,plot=FALSE)$out
Mspeed1 <- Mspeed
Mspeed1 <- Mspeed1[-which(Mspeed1$h1 %in% outliers),]
boxplot(h1~group*Age,data=Mspeed1)
...
boxplot(h1~group*Age,data=SDspeed)
outliers <- boxplot(h1~group*Age,data=SDspeed,plot=FALSE)$out
SDspeed1 <- SDspeed
SDspeed1 <- SDspeed1[-which(SDspeed1$h1 %in% outliers),]
boxplot(h1~group*Age,data=SDspeed1)
...
SDLP <- total %>%
  filter(Variable == "SDLP")
sdlp <- aov(h1 ~ Age*group, data = SDLP,anova_table = list(es = "pes"))
summary(sdlp)
eta_squared(sdlp)
emmeans(sdlp,pairwise ~ group )
emmeans(sdlp,pairwise ~ Age|group)
...
boxplot(h1~group*Age,data=SDLP)
outliers <- boxplot(h1~group*Age,data=SDLP,plot=FALSE)$out
SDLP1 <- SDLP
SDLP1 <- SDLP1[-which(SDLP1$h1 %in% outliers),]
boxplot(h1~group*Age,data=SDLP1)

sdlp <- aov(h1 ~ Age*group, data = SDLP1,anova_table = list(es = "pes"))
summary(sdlp)
eta_squared(sdlp)
emmeans(sdlp,pairwise ~ group )
emmeans(sdlp,pairwise ~ Age|group)
...
SR <- total %>%
  filter(Variable == "Steer Rev")
sr <- aov(h1 ~ Age*group, data = SR,anova_table = list(es = "pes"))
summary(sr)
eta_squared(sr)
emmeans(sr,pairwise ~ Age|group)
emmeans(sr,pairwise ~ group|Age)
...
boxplot(h1~group*Age,data=SR)
outliers <- boxplot(h1~group*Age,data=SR,plot=FALSE)$out
SR1 <- SR
SR1 <- SR1[-which(SR1$h1 %in% outliers),]
boxplot(h1~group*Age,data=SR1)



sr <- aov(h1 ~ Age*group, data = SR2,anova_table = list(es = "pes"))
summary(sr)
eta_squared(sr)
emmeans(sr,pairwise ~ Age|group)
emmeans(sr,pairwise ~ group|Age)
...
boxplot(h1~group*Age,data=LD)
outliers <- boxplot(h1~group*Age,data=LD,plot=FALSE)$out
LD1 <- LD
LD1 <- LD1[-which(LD1$h1 %in% outliers),]
boxplot(h1~group*Age,data=LD1)

LD <- total %>%
  filter(Variable == "Lane departures")
ld <- aov(h1 ~ Age*group, data = LD1,anova_table = list(es = "pes"))
summary(ld)
eta_squared(ld)
emmeans(ld,pairwise ~ group|Age)
emmeans(ld,pairwise ~ scenario)
...
MLO <- total %>%
  filter(Variable == "Mean Long acc")
mlo <- aov(h1 ~ Age*group, data = MLO,anova_table = list(es = "pes"))
summary(mlo)
eta_squared(mlo)
emmeans(mlo,pairwise ~ Age)
emmeans(mlo,pairwise ~ scenario)
...
boxplot(h1~group*Age,data=MLO)
outliers <- boxplot(h1~group*Age,data=MLO,plot=FALSE)$out
MLO1 <- MLO
MLO1 <- MLO1[-which(MLO1$h1 %in% outliers),]
boxplot(h1~group*Age,data=MLO1)

MLO <- total %>%
  filter(Variable == "Mean Long acc")
mlo <- aov(h1 ~ Age*group, data = MLO1,anova_table = list(es = "pes"))
summary(mlo)
eta_squared(mlo)
emmeans(mlo,pairwise ~ Age)
emmeans(mlo,pairwise ~ Age|group)
...
SLO <- total %>%
  filter(Variable == "SD Long acc")
slo <- aov(h1 ~ Age*group, data = SLO,anova_table = list(es = "pes"))
summary(slo)
eta_squared(slo)
emmeans(slo,pairwise ~ Age|group)
emmeans(slo,pairwise ~ Age)
...
boxplot(h1~group*Age,data=SLO)
outliers <- boxplot(h1~group*Age,data=SLO,plot=FALSE)$out
SLO1 <- SLO
SLO1 <- SLO1[-which(SLO1$h1 %in% outliers),]
boxplot(h1~group*Age,data=SLO1)



slo <- aov(h1 ~ Age*group, data = SLO1,anova_table = list(es = "pes"))
summary(slo)
eta_squared(slo)
emmeans(slo,pairwise ~ Age|group)
emmeans(slo,pairwise ~ group|Age)
...
boxplot(h3~group*Age,data=Mspeed)
outliers <- boxplot(h3~group*Age,data=Mspeed,plot=FALSE)$out
Mspeed1 <- Mspeed
Mspeed1 <- Mspeed1[-which(Mspeed1$h3 %in% outliers),]
boxplot(h3~group*Age,data=Mspeed1)
...
boxplot(h3~group*Age,data=SDspeed)
outliers <- boxplot(h3~group*Age,data=SDspeed,plot=FALSE)$out
SDspeed1 <- SDspeed
SDspeed1 <- SDspeed1[-which(SDspeed1$h3 %in% outliers),]
boxplot(h3~group*Age,data=SDspeed1)
...
SDLP <- total %>%
  filter(Variable == "SDLP")
sdlp <- aov(h3 ~ Age*group, data = SDLP,anova_table = list(es = "pes"))
summary(sdlp)
eta_squared(sdlp)
emmeans(sdlp,pairwise ~ group )
emmeans(sdlp,pairwise ~ Age|group)
...
boxplot(h3~group*Age,data=SDLP)
outliers <- boxplot(h3~group*Age,data=SDLP,plot=FALSE)$out
SDLP1 <- SDLP
SDLP1 <- SDLP1[-which(SDLP1$h3 %in% outliers),]
boxplot(h3~group*Age,data=SDLP1)

sdlp <- aov(h3 ~ Age*group, data = SDLP1,anova_table = list(es = "pes"))
summary(sdlp)
eta_squared(sdlp)
emmeans(sdlp,pairwise ~ group )
emmeans(sdlp,pairwise ~ Age|group)
...
MLO <- total %>%
  filter(Variable == "Mean Long acc")
mlo <- aov(h3 ~ Age*group, data = MLO,anova_table = list(es = "pes"))
summary(mlo)
eta_squared(mlo)
emmeans(mlo,pairwise ~ Age)
emmeans(mlo,pairwise ~ scenario)
...
boxplot(h3~group*Age,data=MLO)
outliers <- boxplot(h3~group*Age,data=MLO,plot=FALSE)$out
MLO1 <- MLO
MLO1 <- MLO1[-which(MLO1$h3 %in% outliers),]
boxplot(h3~group*Age,data=MLO1)

MLO <- total %>%
  filter(Variable == "Mean Long acc")
mlo <- aov(h3 ~ Age*group, data = MLO1,anova_table = list(es = "pes"))
summary(mlo)
eta_squared(mlo)
emmeans(mlo,pairwise ~ Age)
emmeans(mlo,pairwise ~ Age|group)
...
SLO <- total %>%
  filter(Variable == "SD Long acc")
slo <- aov(h3 ~ Age*group, data = SLO,anova_table = list(es = "pes"))
summary(slo)
eta_squared(slo)
emmeans(slo,pairwise ~ Age|group)
emmeans(slo,pairwise ~ Age)
...
boxplot(h3~group*Age,data=SLO)
outliers <- boxplot(h3~group*Age,data=SLO,plot=FALSE)$out
SLO1 <- SLO
SLO1 <- SLO1[-which(SLO1$h3 %in% outliers),]
boxplot(h3~group*Age,data=SLO1)

slo <- aov(h3 ~ Age*group, data = SLO1,anova_table = list(es = "pes"))
summary(slo)
eta_squared(slo)
emmeans(slo,pairwise ~ Age|group)
emmeans(slo,pairwise ~ group)
...
MLA <- total %>%
  filter(Variable == "Mean lat acc")
mlo<- aov(hills ~ Age*group, data = MLA,anova_table = list(es = "pes"))
summary(mlo)
emmeans(mlo,pairwise ~ Age)
emmeans(mlo,pairwise ~ scenario)
emmip(mlo, ~ group)
...
boxplot(hills1~group*Age,data=MLA)
outliers <- boxplot(hills~group*Age,data=MLA,plot=FALSE)$out
MLA1 <- MLA
MLA1 <- MLA1[-which(MLA1$hills %in% outliers),]
boxplot(hills ~group*Age,data=MLA1)

MLA <- total %>%
  filter(Variable == "Mean Lat acc")
mlo<- aov(hills ~ Age*group, data = MLA1,anova_table = list(es = "pes"))
summary(mlo)
emmeans(mlo,pairwise ~ Age)
emmeans(mlo,pairwise ~ group|Age)
emmeans(mlo,pairwise ~ group)
...
SLA <- total %>%
  filter(Variable == "SD lat acc")
sla <- aov(hills ~ Age*group, data = SLA)
summary(sla)
emmeans(sla,pairwise ~ Age|group)
emmeans(sla,pairwise ~ Age)
emmip(sla, ~ group)
...
boxplot(hills~group*Age,data=SLA)
outliers <- boxplot(hills~group*Age,data=SLA,plot=FALSE)$out
SLA1 <- SLA
SLA1 <- SLA1[-which(SLA1$hills %in% outliers),]
boxplot(hills~group*Age,data=SLA1)

SLA <- total %>%
  filter(Variable == "SD lat acc")
sla <- aov(hills ~ Age*group, data = SLA1)
summary(sla)
emmeans(sla,pairwise ~ Age|group)
emmeans(sla,pairwise ~ group|Age)
emmip(sla, ~ group)
